...
def ensure_campaign_operational_columns(target_engine: Engine) -> None:
    expected_columns = {
        ...
        'send_delay_min_seconds': 'ALTER TABLE campaigns ADD COLUMN send_delay_min_seconds INTEGER NOT NULL DEFAULT 15',
        'send_delay_max_seconds': 'ALTER TABLE campaigns ADD COLUMN send_delay_max_seconds INTEGER NOT NULL DEFAULT 45',
        'batch_pause_min_seconds': 'ALTER TABLE campaigns ADD COLUMN batch_pause_min_seconds INTEGER NOT NULL DEFAULT 25',
        'batch_pause_max_seconds': 'ALTER TABLE campaigns ADD COLUMN batch_pause_max_seconds INTEGER NOT NULL DEFAULT 40',
        'batch_size_initial': 'ALTER TABLE campaigns ADD COLUMN batch_size_initial INTEGER NOT NULL DEFAULT 5',
        'batch_size_max': 'ALTER TABLE campaigns ADD COLUMN batch_size_max INTEGER NOT NULL DEFAULT 15',
        ...
        conn.execute(
            text(
                ...
                SET speed_profile = COALESCE(speed_profile, 'conservative'),
                    send_delay_min_seconds = COALESCE(send_delay_min_seconds, 15),
                    send_delay_max_seconds = COALESCE(send_delay_max_seconds, 45),
                    batch_pause_min_seconds = COALESCE(batch_pause_min_seconds, 25),
                    batch_pause_max_seconds = COALESCE(batch_pause_max_seconds, 40),
                    batch_size_initial = COALESCE(batch_size_initial, 5),
                    batch_size_max = COALESCE(batch_size_max, 15),
